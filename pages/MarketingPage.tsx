...
import { Plus, Mail, MessageSquare, MousePointer } from 'lucide-react';
...
export const MarketingPage: React.FC = () => {
  ...
  const columns = [
    { header: 'Campanha', accessor: 'name', className: 'font-medium' },
    { 
      header: 'Canal', 
      accessor: (row: any) => (
    ...
    { header: 'Audiência', accessor: 'audience' },
    { header: 'Conversão', accessor: 'conversion' },
  ];
