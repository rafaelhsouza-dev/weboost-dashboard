...
<div class="container-fluid p-0" id="viewContent">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Configurações da Visão Geral</h5>
        </div>
        <div class="card-body">
            <p class="text-muted">As configurações específicas para o dashboard geral estarão aqui.</p>
